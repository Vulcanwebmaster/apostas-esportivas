...
class IMGCanvas
{
    ...
    private $nova_largura, $nova_altura, $tamanho_html;
    ...
    /**
     * Construtor
     * @param string $origem caminho da imagem a ser carregada [opcional]
     * @return void
     * */
...
// fim construtor
    ...
    private function criaImagem()
    {
        switch ($this->formato) {
            ...
            case 3:
                ...
                break;
            case 6:
                $this->img = self::imagecreatefrombmp($this->origem);
                $this->extensao = 'bmp';
                break;
            default:
     ...
     * @param string|int $g
     * @param string|int $b
     * @return $this instância atual do objeto, para métodos encadeados
     * */
...
// fim carregaUrl
     ...
     * @param string $origem caminho da imagem a ser carregada
     * @return $this instância atual do objeto, para métodos encadeados
     * */
...
// fim rgb
     ...
     * @param bool $truetype true para utilizar fonte truetype, false para fonte do sistema
        ...
        if ($imagem) {
            ...
            switch (strtolower($pathinfo['extension'])) {
                ...
                case 'gif':
                    ...
                    break;
                case 'bmp':
                    $marcadagua = self::imagecreatefrombmp($imagem);
                    break;
                default:
